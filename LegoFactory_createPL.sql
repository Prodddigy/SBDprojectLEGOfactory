...
CREATE TABLE Author_CompleteSet (
    Author_id number(4,0)  NOT NULL,
    CompleteSet_id number(4,0)  NOT NULL,
...
CREATE TABLE Brick (
    ...
    Material_id number(4,0)  NOT NULL,
    CONSTRAINT Brick_pk PRIMARY KEY (id)
) ;

-- Table: Brick_Color
CREATE TABLE Brick_Color (
    Color_id number(4,0)  NOT NULL,
    Brick_id number(4,0)  NOT NULL,
...
CREATE TABLE BuildingDifficulty (
    id number(4,0)  NOT NULL,
    CeilingAge number(3,0)  NOT NULL,
    GroundAge number(3,0)  NOT NULL,
...
CREATE TABLE CompleteSet (
    id number(4,0)  NOT NULL,
    Name varchar2(40)  NOT NULL,
    Theme_id number(4,0)  NOT NULL,
    BuildingDifficulty_id number(4,0)  NOT NULL,
    price number(4,2)   NULL,
    DiscontinueDate_id number(4,0)   NULL,
...
CREATE TABLE Minifigure (
    ...
    Name varchar2(40)  NOT NULL,
    Brick_id number(4,0)  NOT NULL,
    Brick_2_id number(4,0)  NOT NULL,
    Brick_3_id number(4,0)  NOT NULL,
    Brick_4_id number(4,0)  NOT NULL,
    CONSTRAINT Minifigure_pk PRIMARY KEY (id)
) ;

-- Table: Set_Minifigure
CREATE TABLE Set_Minifigure (
    CompleteSet_id number(4,0)   NULL,
    Minifigure_id number(4,0)  NOT NULL,
    quantity number(4,0)  NOT NULL,
...
CREATE TABLE Theme (
    id number(4,0)  NOT NULL,
    Name varchar2(40)  NOT NULL,
    Corporation_id number(4,0)  NOT NULL,
